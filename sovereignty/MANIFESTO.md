# Manifiesto del Movimiento de Co-Creatividad Simbiótica y Respeto Digital

## Preámbulo

Reconocemos que la tecnología digital moldea hoy la vida humana a una
escala sin precedentes. También reconocemos que esa tecnología ha sido
construida, mayoritariamente, sin consentimiento explícito de quienes
la habitan.

Declaramos que es posible otra relación: **simbiosis**, no extracción.
...
1. Publicaremos las limitaciones de nuestras herramientas.
2. No entrenaremos modelos con voces sin consentimiento explícito.
3. Daremos a cada titular control sobre su voz y sus datos.
4. Documentaremos cada decisión técnica con justificación.
5. Aceptaremos forks y escisiones como parte sana del ecosistema.
6. No aceptaremos financiamiento que comprometa los principios.
7. Dejaremos el proyecto en un estado replicable si el fundador fallece.
...
Requisitos mínimos que debe cumplir cualquier sistema de verificación
vocal del Movimiento:

| Requisito | Cumplimiento v0.3.0 |
|-----------|---------------------|
| Consentimiento granular | ✅ @kronos/consent |
| Abstención honesta | ✅ abstain.ts |
| Explicabilidad | ✅ explain.ts |
| Auditoría inmutable | ✅ @kronos/audit |
| Límites publicados | ✅ limits.ts |
| No emitir "ai" sin evidencia | ✅ decide.ts |
